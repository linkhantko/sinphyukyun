            ...
            <div class="container">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-12 col-md-12 wow fadeInUp" data-wow-delay="0.1s">
                        <div class="rounded">
                            <div class="p-5">
                                <h6 class="mb-3 text-center" style="letter-spacing: 2px; line-height: 1.7;">Furthermore, since our core belief is to maintain a transparent, professional and ethical business dealings with our partners as well as customers, by mid of year 2020, we have successfully implemented state of the art
